...
```
python3 .claude/commands/commit/scripts/git-summary.py
```
...
- scope: web, admin, api 또는 생략 (루트/전체)
- subject는 한글, 명령형으로 작성
- 한 커밋에 하나의 논리적 변경만 포함

## 수행 절차

1. `python3 .claude/commands/commit/scripts/git-summary.py` 실행하여 변경사항 확인
